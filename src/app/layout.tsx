...
export const metadata: Metadata = {
  ...
  description: `${SCHOOL_INFO.name} is an independent combined school in Winterveldt, Pretoria, Gauteng. Serving ${SCHOOL_INFO.totalLearners} learners with a ${SCHOOL_INFO.studentTeacherRatio} student-teacher ratio. Contact us at ${SCHOOL_INFO.phone}.`,
  keywords: [
    "Asamaths Institute",
    "Pretoria school",
    "Winterveldt school",
    "independent school Gauteng",
    "combined school Pretoria",
    "private school South Africa",
    SCHOOL_INFO.name,
  ],
  openGraph: {
    title: SCHOOL_INFO.name,
    description: `Independent combined school in Winterveldt, Pretoria. ${SCHOOL_INFO.totalLearners} learners, ${SCHOOL_INFO.totalEducators} educators.`,
    type: "website",
    locale: "en_ZA",
