...
export const metadata: Metadata = {
  title: "About Us",
  description: `Learn about ${SCHOOL_INFO.name}, an independent combined school in Winterveldt, Pretoria. Meet our principal, ${SCHOOL_INFO.principal}, and discover our mission.`,
}
